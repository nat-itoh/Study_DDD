...
namespace Project.CameraModule {
    ...
    public class CameraLocationController : MonoBehaviour, ICameraController {
        ...
        [SerializeField] private float _tiltAngle = 10f;    // cameraTransform.right (X軸)周りの回転角度
        [SerializeField] private float _headingAngle = 0f;  // parentTransform.up (Y軸)周りの回転角度
        [SerializeField] private float _distance = 5f;      // 
        [Space]
        [SerializeField] private Vector2 _offset = Vector2.zero;
        [SerializeField] private Vector3 _defaultTargetPos = Vector3.zero;
        ...
        public static readonly float MAX_DISTANCE = 500f;
