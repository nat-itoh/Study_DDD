...
namespace Project.Infrastructure.Setting {
    ...
    public sealed class SettingsAPIGateway {
        ...
        private const string VoiceVolumePrefsKey = Prefix + "_VoiceVolume";
        private const string BgmVolumePrefsKey = "Settings_BgmVolume";
        private const string SeVolumePrefsKey = "Settings_SeVolume";
        private const string IsVoiceMutedPrefsKey = "Settings_VoiceMuted";
        private const string IsBgmMutedPrefsKey = "Settings_BgmMuted";
